...
async def config(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await context.bot.send_message(update.message.chat.id, 
                                   text="La configuración de la Raspberry Pi Pico es:\n" +
                                        "Nombre del dispositivo: " + os.environ["ID_DISPOSITIVO"] + 
                                        "\nEl modo del Rele es:" + rele +
                                        "\nEl periodo de sensado es:" + context.bot_data['periodo'] +
                                        "\nEl modo de operación del rele es:" + modo_operacion +
                                        "\nEl setpoint de temperatura es:" + context.bot_data['setpoint'])
